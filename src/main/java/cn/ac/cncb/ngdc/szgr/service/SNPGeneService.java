...
@Service
public class SNPGeneService {
    @Autowired
    SNPGeneDAO snpGeneDAO;

    public Result querySNPGene(Integer pageSize, Integer pageIndex, String vid, String sort_field, String sort_direction){
        Long total = 0L;
        List<SNPGene> data = null;
        Meta meta = new Meta();
        Specification<SNPGene> queryCondition = new Specification<SNPGene>(){
            @Override
            public Predicate toPredicate(Root<SNPGene> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        ...
        try {
            data = snpGeneDAO.findAll(queryCondition, PageRequest.of(pageIndex, pageSize)).getContent();
            if (vid == null ){
                total = 1L;
            }else {
                total = snpGeneDAO.count(queryCondition);
            }
            meta.setTotal(total);
    ...
    public Result querySNPGenelike(Integer pageSize, Integer pageIndex, String vid, String sort_field, String sort_direction){
        Long total = 0L;
        List<SNPGene> data = null;
        Meta meta = new Meta();
        Specification<SNPGene> queryCondition = new Specification<SNPGene>(){
    ...
    public Result queryLocGene(Integer pageSize, Integer pageIndex, String vchr, Integer vs, Integer ve, String sort_field, String sort_direction) {
        Long total = 0L;
        List<SNPGene> data = null;
        Meta meta = new Meta();
        Specification<SNPGene> queryCondition = new Specification<SNPGene>() {
